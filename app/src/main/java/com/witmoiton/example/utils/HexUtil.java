...
public class HexUtil {
    ...
    public static String formatByteHexString(byte data) {
        StringBuilder sb = new StringBuilder();
     ...
     * @return
     */
    public static String hex10To16Dec(String hex) {
        int data = Integer.parseInt(hex, 10);
        String str = Integer.toString(data, 16);
        if (str.length() < 2) {
            str = "0" + str;
        }
        return str;
